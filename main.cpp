...
static const string mainnet_seeds[] = {"explorer.chaucha.cl", "pool.chaucha.cl", ""};
static const string testnet_seeds[] = {"explorer.chaucha.cl", "pool.chaucha.cl", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 21663), true);
  }
  do {
